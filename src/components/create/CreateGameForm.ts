                ...
                <div class="create-game-options">
                    ...
                    <div class="create-game-page-container">
                        ...
                        <div class="create-game-page-column">
                            ...
                            <input type="checkbox" name="doubleCorp" id="doubleCorp-checkbox" v-model="doubleCorp">
                        ...
                        <div class="create-game-page-column" v-if="playersCount > 1">
                            ...
                            <input type="checkbox" name="randomMAToggle" v-model="randomMACheckbox" id="randomMA-checkbox" v-on:change="randomMAToggle()">
